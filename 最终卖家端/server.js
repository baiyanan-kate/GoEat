...
router.route('/shops')
    ...
    .post(function(req, res) {
        ...
        shop.shopImage = "img/"+shop.shopName+".png";
        var saveImage = "/Users/zzg/desktop/buyer/public/img/"+shop.shopName+".png";
        ...
        shop.save(function(err) {
            ...
            //将图片写入文件
            fs.writeFile(saveImage, dataBuffer, function(err) {
                if(err){
                    res.send(err);
                }else{
                    res.json({ message: 'OK' });
...
// create a bear (accessed at POST http://localhost:8080/bears)
    .post(function(req, res) {
        ...
        product.productImage = "img/"+product.productName+".png";
        var saveImage1 = "/Users/zzg/desktop/buyer/public/img/"+product.productName+".png";
        var saveImage2 = "/Users/zzg/desktop/seller/public/img/"+product.productName+".png";
        ...
        product.save(function(err) {
            if (err)
                res.send(err);
            //将图片写入买家
            fs.writeFile(saveImage1, dataBuffer, function(err) {
                if(err){
                    res.send(err);
                }else{
                    res.json({ message: 'OK' });
            ...
            //将图片写入卖家
            fs.writeFile(saveImage2, dataBuffer, function(err) {
